...
## Project Structure
    ...
    ├── storyboard_mobilete_27664  # Django project configurations
...
1. Clone this repo and `cd storyboard_mobilete_27664`
...
2. Clone this repo and `cd storyboard_mobilete_27664`
