"""
Django settings for storyboard_mobilete_27664 project.
...
ROOT_URLCONF = 'storyboard_mobilete_27664.urls'
...
WSGI_APPLICATION = 'storyboard_mobilete_27664.wsgi.application'
